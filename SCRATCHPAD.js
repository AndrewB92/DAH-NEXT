        ...
        <Col>
            ...
            <Row>
                <Col>
                    ...
                    <Form.Control type="text" placeholder="Phone (Full international dialling code please) e.g. +353 1 12345678" { ...register("phone", {required: "* Phone number is required" })} />
                </Col>
            </Row>
            <Row>
                <Col>
    ...
    <Row>
        <Col>
            ...
            <div className={styles.propertySubData}>
                <p><span className={styles.bolder}>Payment Terms:</span> If your arrival date is more than 30 days from booking date you need only pay a booking deposit of 30% although you may pay in full if you prefer. Any balance payable is due 30 days prior to arrival date.</p>
            ...
            <Row>
                <Col>
                    <div className={styles.propertySubData}>
                        <h5>Total in Euro:</h5>
                        {depositPaymentAllowed && (
                        <h5>Deposit if due:</h5>
                        )}
                    </div>
                </Col>
                <Col>
