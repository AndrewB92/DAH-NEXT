...
const BKEnquiryCard = () => {
    return (
        <div className="cont cont-col gap-24 enquiry-card">
            <h2 className="enquiry-title">Not ready to book yet?</h2>
            <p className="cta-description">Make a general enquiry and ask us to find you a property which suits you time and location. One of our property team will get back to you as soon as we receive your enquiry.</p>
            <a href={`${rootUrl}/make-an-enquiry/`} className="cta-main green booking-btn">
